...
public class FirstCare {
  ...
  public FirstCare() {
    ...
    public FirstCare(People patient, CID cid, Hospital hospital, SpecialistMedic specialist_medics, CareStatus care_status, CareSector sector, SeverityLevel severityLevel) {
